// целта е да представим в JavaScript двумерна дъска за игра, (например - "Морски шах"), 
// която в последствие ще можем лесно да променяме за да отразим текущото състояние на играта.
